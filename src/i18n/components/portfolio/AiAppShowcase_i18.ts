...
export const aiWorks: AiWork[] = [
    ...
    },
    {
        ...
        caption: {
            en: "Built on Mitsuba 3 physically based rendering, solving 3D lighting back from a 2D image.",
            zh: "基于 Mitsuba3 物理渲染，将 2D 图像反向求解为 3D 灯光。",
            ja: "Mitsuba 3 の物理ベースレンダリングで、2D 画像から 3D ライティングを逆算。",
            ko: "Mitsuba 3 물리 기반 렌더링으로 2D 이미지에서 3D 조명을 역으로 풀어냅니다.",
        },
    ...
    },
    {
        ...
        caption: {
            en: "EDA, feature engineering, classification with threshold tuning, and SHAP explainability analysis.",
            zh: "EDA、特征工程、分类与阈值优化，SHAP 可解释性分析。",
