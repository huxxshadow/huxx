...
export const devWorks: DevWork[] = [
    {
        ...
        stack: [],
        line: {
            en: "Developed the in-game camera system and implemented the stylized interactive foliage.",
            zh: "负责游戏内相机系统开发，以及风格化交互植被的技术实现。",
            ja: "ゲーム内カメラシステムの開発と、スタイライズされたインタラクティブな植生の技術実装を担当しました。",
            ko: "게임 내 카메라 시스템 개발과 스타일라이즈드 인터랙티브 식생의 기술 구현을 맡았습니다.",
        },
        systems: [],
    },
    {
    ...
    },
    {
        ...
        caption: {
            en: "Built modular rhythm-game and dialogue systems, and a content pipeline that several people can work in at the same time.",
            zh: "搭建模块化的音游系统与对话系统，实现多人并发的生成管线。",
            ja: "モジュール式のリズムゲームシステムと会話システムを構築し、複数人が同時に作業できる生成パイプラインを実現しました。",
            ko: "모듈형 리듬 게임 시스템과 대화 시스템을 구축하고, 여러 사람이 동시에 작업할 수 있는 생성 파이프라인을 구현했습니다.",
        },
    ...
    },
    {
        ...
        line: {
            ...
            ja: "AAA 水準のパルクール移動・カメラシステムを一人で実装（Motion Warping、物理計算、Locomotion、複雑な動的カメラ）。",
